...
module.exports = [
    ...
    { method: 'GET', path: '/userinfo', config: Accounts.userinfo },
    ...
    { method: 'GET', path: '/poiRegionSelect/{id}', config: Pois.poiRegionSelect},
    ...
    {method: 'GET', path: '/deletePoiImage/{id}', config: Gallery.deleteImage},
